...
import InteractionChatItem from './InteractionChatItem';


const MaintenanceInteractionChat = () =>  {
    var data = [
        {
            id: 0,
        ...
        {
            id: 1,
            datetime: "Tue 25/06/2015 - 06:39 PM",
            name: "Michael Smith",
            text: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",
            type: "landlord"
        },
        {
            id: 2,
            datetime: "Tue 25/06/2015 - 08:39 PM",
            name: "Smith Jordan",
            text: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",
            type: "tenant"
        },
  ...
  return (
    <div className="ibox">
        ...
        <div className="ibox-content minhigh">
                {data.length > 0 ? (
                    data.map((item, index) => {
                    return <InteractionChatItem key={index} {...item} />;
                    })
                    ) : (
                    <Empty />
                )}
...
export default MaintenanceInteractionChat;